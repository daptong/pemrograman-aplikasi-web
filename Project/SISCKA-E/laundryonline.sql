...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2022 at 08:38 AM
...
(6, 35, 'adrian natabuwana', '2022-06-12', '2022-06-12', 'Jakarta', 'ON HOLD', 15000, 'Freddy Yohanes Patty'),
(7, 36, 'adrian natabuwana', '2022-06-12', '2022-06-12', 'Jakarta', 'DELIVERING', 15000, 'Ahmad Naufal');
...
(6, 'adrian natabuwana', 'adrian', '$2y$10$kuL39pW/K7uiv8pC.cGU.OidtpvZbihoABXaQC.zAteA.ELNeo.2q', 'Jakarta', '08198765432', 'adrian@google.com', 0);
...
(35, 'adrian natabuwana', '2022-06-12', 'Pakaian', 'Express', 'Antar', 6, 75000),
(36, 'adrian natabuwana', '2022-06-12', 'Bed Cover', 'Express', 'Antar', 4, 68000);
...
--
ALTER TABLE `paket`
  MODIFY `paket_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `pelanggan`
--
ALTER TABLE `pelanggan`
  MODIFY `pelanggan_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `status_laundry`
--
ALTER TABLE `status_laundry`
  MODIFY `status_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `transaksi`
--
ALTER TABLE `transaksi`
  MODIFY `transaksi_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
COMMIT;
